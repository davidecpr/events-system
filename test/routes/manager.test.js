...
test('cannot add logo, without login', async (t) => {
  ...
  const res = await app.inject({
    method: 'POST',
    url: '/api/managers/logo/601024ab43d29b1cf1d7e357',
    body: form,
...
test('cannot add logo, wrong id', async (t) => {
  ...
  const res = await app.inject({
    method: 'POST',
    url: '/api/managers/logo/1111111111116994534a5',
    body: form,
    headers: form.getHeaders()
  })
...
testWithLogin('cannot add logo, no file uploaded', async (t, inject) => {
  ...
  const managerResponse = await inject({
    method: 'POST',
    url: `/api/managers/logo/${newManager._id}`,
    body: form,
    headers: form.getHeaders()
  })
...
test('cannot get logo, wrong id', async (t) => {
  ...
  const res = await app.inject({
    method: 'GET',
    url: '/managers/logo/1111111111116994534a5'
  })
...
test('cannot get logo, manager not found', async (t) => {
  ...
  const res = await app.inject({
    method: 'GET',
    url: '/managers/logo/601024ab43d29b1cf1d7e357'
  })
...
testWithLogin('get logo', async (t, inject) => {
  ...
  const res = await inject({
    method: 'GET',
    url: `/managers/logo/${newManager._id}`
  })
